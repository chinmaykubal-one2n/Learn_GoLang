...
func (m *MockStudentService) ListStudents() ([]model.Student, error) {
	args := m.Called()
...
func (m *MockStudentService) CreateStudent(s model.Student) (model.Student, error) {
	args := m.Called(s)
	return args.Get(0).(model.Student), args.Error(1)
}

func (m *MockStudentService) UpdateStudent(id string, s model.Student) (model.Student, error) {
	args := m.Called(id, s)
	return args.Get(0).(model.Student), args.Error(1)
}
...
func TestGetStudent(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockService.On("GetStudent", "1").Return(mockStudent, nil)
		...
		mockService.AssertCalled(t, "GetStudent", "1")
	})

	t.Run("not found", func(t *testing.T) {
		mockService.On("GetStudent", "999").Return(model.Student{}, errors.New("Student not found"))
		...
		mockService.AssertCalled(t, "GetStudent", "999")
...
func TestCreateStudent(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockService.On("CreateStudent", input).Return(output, nil)
		...
		mockService.AssertCalled(t, "CreateStudent", input)
	})
	...
	t.Run("service error", func(t *testing.T) {
		...
		mockService.On("CreateStudent", input).Return(model.Student{}, errors.New("something went wrong"))
...
func TestUpdateStudent(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockService.On("UpdateStudent", id, input).Return(output, nil)
...
func TestDeleteStudent(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		id := "1"
		mockService.On("DeleteStudent", id).Return(nil)
...
func TestListStudents(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		mockService.On("ListStudents").Return(students, nil)
